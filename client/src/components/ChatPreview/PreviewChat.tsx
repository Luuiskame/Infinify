      ...
      {chats?.map((chat) => (
        ...
        >
          <div className="flex gap-2 items-center">
            <Image
              src={userId === chat.chat_participants[0].user_id ? chat.chat_participants[1].profile_photo : chat.chat_participants[0].profile_photo }
              width={24}
              height={24}
              className="w-8 h-8 rounded-full"
              alt={userId === chat.chat_participants[0].user_id ? chat.chat_participants[1].display_name : chat.chat_participants[0].display_name}
            />
            <div>
              <p className="text-sm font-semibold">{userId === chat.chat_participants[0].user_id ? chat.chat_participants[1].display_name : chat.chat_participants[0].display_name}</p>
